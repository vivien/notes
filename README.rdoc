...
Notes supports the Github Flavored Markdown 
([GFM](https://help.github.com/articles/github-flavored-markdown)) for easy 
listing in README or any Markdown files to be rendered on Github. See the `-g` 
option.
